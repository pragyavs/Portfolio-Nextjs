      ...
      overflow-x-hidden overflow-y-scroll">
        ...
        <section className="max-w-containerSmall mx-auto py-08 lgl:py-30 flex flex-col gap-8">
          ...
          <div className='flex flex-col lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4 p-5'>
            <p>Hello! I'm Pragay Singh, a  backend developer specializing in Node.js and AWS, and a passionate content creator on YouTube. I'm delighted to have you here, and I'd love to share a bit more about myself and what drives my passion for technology.
